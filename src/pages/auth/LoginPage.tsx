...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Credentials verified — move to 2FA step instead of navigating immediately
      setIsLoading(false);
      setStep('otp');
    } catch (err) {
                ...
                <div className="flex justify-center">
                  <OtpInput
                    ...
                    renderInput={(props) => (
                      <input
                        {...props}
                        className="!w-10 h-12 text-center text-lg border border-gray-300 rounded-md focus:border-primary-500 focus:ring-1 focus:ring-primary-500 outline-none"
                      />
                    )}
                  />
                </div>
